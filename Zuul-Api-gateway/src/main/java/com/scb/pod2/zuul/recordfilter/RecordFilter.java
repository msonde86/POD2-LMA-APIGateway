package com.scb.pod2.zuul.recordfilter;
...
@Component
public class RecordFilter implements GatewayFilter, Ordered {
	...
	public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
		...
		if ("POST".equals(method) && !contentType.startsWith("multipart/form-data")) {
			...
			// Next, the request body is encapsulated and written back to the request and
